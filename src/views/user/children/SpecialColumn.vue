    ...
    <div class="ksd-main-content">
      <div style="padding:15px;background: #fff;">
        <div id="ksd-topic-cube-list-add" :class="{show: indexOfFlag('other/user')}" class="ksd-topic-cube-list">
          ...
          <div class="media ksd-editmode text-muted ksd-topic-items-c" :class="{special_display:this.specialCreate}" style="background-image: linear-gradient(to top, #fbc2eb 0%, #a6c1ee 100%);width:422px;">
            <a href="javascript:void(0);" class="text-white font-weight-bold text-decoration-none d-block">
              <div class="media-body load-topics-page pr">
                <h3 class="zl-title" style="width: 384px;"><input maxlength="60" id="ksd-zl-title-input" autofocus="autofocus" style="padding:2px 4px;font-size:12px;text-indent: 0.5em;border-radius:8px;" placeholder="输入专栏名称..." type="text"></h3>
              </div>
