        ...
        <div id="submit-video-list" class="content person_works">
          <ul id="ksd-course-cube-list" class="work_lists cl">
            <li data-courseid="1325771226245623809" data-pages="2" data-total="22" class="z pos animated fadeIn delay-1s">
              ...
              <img class="imgloadinglater" onerror="imgError(this)" src="../../../assets/footimg/850301863063588864.jpg" alt="如何准备面试"></a>
              <div class="work_bt"><a target="_blank" title="如何准备面试" href="/course/detail/1325771226245623809" class="title">微信支付系列</a>
