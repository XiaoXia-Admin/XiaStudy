  ...
  <div class="title-article"
    ...
    <div class="title-msg">
                        ...
                        <span data-v-a73170e6="" class="svipicon"><svg data-v-a73170e6="" t="1644496904794"
                                                                       ...
                                                                       xmlns="http://www.w3.org/2000/svg" p-id="2852"
                                                                       width="32" height="32" class="icon"
                                                                       style="position: relative; top: 12px; left: 1px;"><path
                          data-v-a73170e6=""
      ...
      <span v-show="indexOfFlag('/bbs/preview')" class="c999"><a href="#comments"
                                                                 class="c999">评论：<span>{{ this.commentNumber }}</span></a></span>&nbsp;&nbsp;
      ...
      <a v-show="indexOfFlag('/bbs/preview') && !this.leftFlag" @click="displayLeftToc" href="javascript:void(0);"
